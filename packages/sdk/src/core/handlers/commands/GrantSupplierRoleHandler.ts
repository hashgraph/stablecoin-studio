...
@Command('grantSupplierRole')
export class GrantSupplierRoleHandler extends BaseCommandHandler<TargetAmountParams, TargetAmountResult> {
  constructor() {
    super('grantSupplierRole', ['function grantSupplierRole(address account, uint256 amount)'], 80_000);
  }
