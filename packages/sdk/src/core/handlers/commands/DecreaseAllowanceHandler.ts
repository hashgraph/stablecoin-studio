...
export class DecreaseAllowanceHandler extends BaseCommandHandler<TargetAmountParams, TargetAmountResult> {
  constructor() {
    super('decreaseSupplierAllowance', ['function decreaseSupplierAllowance(address account, uint256 amount)'], 80_000);
  }
