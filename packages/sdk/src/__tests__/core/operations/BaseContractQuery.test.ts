...
import { BaseContractQuery } from '../../../core/operations/BaseContractQuery.js';
import { QueryParams, QueryResult } from '../../../core/operations/types.js';
...
class TestQueryHandler extends BaseContractQuery<TestQueryParams, TestQueryResult> {
  constructor() {
...
class NoExtraParamsHandler extends BaseContractQuery<QueryParams, TestQueryResult> {
  constructor() {
