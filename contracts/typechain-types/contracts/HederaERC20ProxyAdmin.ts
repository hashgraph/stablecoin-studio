...
export interface HederaERC20ProxyAdminInterface extends utils.Interface {
  functions: {
...
export interface HederaERC20ProxyAdmin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HederaERC20ProxyAdminInterface;
