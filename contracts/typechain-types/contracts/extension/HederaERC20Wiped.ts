...
export interface HederaERC20WipedInterface extends utils.Interface {
  functions: {
    ...
    "wipeToken(address,uint32)": FunctionFragment;
  };
...
export interface HederaERC20Wiped extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HederaERC20WipedInterface;
