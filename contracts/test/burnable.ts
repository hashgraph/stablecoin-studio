...
describe("Burn tokens", function() {
  ...
  it("Can burn 100 tokens from the treasury account having 100 tokens", async function() {
  ...
  it("Cannot burn 101 tokens from the treasury account having 100 tokens", async function() {
