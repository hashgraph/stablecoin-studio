...
export const UPDATE_TOKEN_GAS = 140000;
export const UPDATE_RESERVE_AMOUNT_GAS = 40000;
export const CHANGE_PROXY_OWNER_GAS = 50000;
export const ACCEPT_PROXY_OWNER_GAS = 40000;
export const UPDATE_PROXY_IMPLEMENTATION_GAS = 40000;
export const ASSOCIATE_GAS = 7000000;
export const UPDATE_CUSTOM_FEES_GAS = 7000000;
