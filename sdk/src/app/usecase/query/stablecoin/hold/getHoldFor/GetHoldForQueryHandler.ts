...
import { GetHeldAmountForQueryResponse } from '../getHeldAmountFor/GetHeldAmountForQuery.js';
import { BigDecimal } from 'port/in/StableCoin.js';

@QueryHandler(GetHoldForQuery)
export class GetHeldAmountForQueryHandler
	implements IQueryHandler<GetHoldForQuery>
{
	constructor(
	...
	async execute(command: GetHoldForQuery): Promise<GetHoldForQueryResponse> {
		...
		return Promise.resolve(new GetHeldAmountForQueryResponse(holdDetail));
	}
}
