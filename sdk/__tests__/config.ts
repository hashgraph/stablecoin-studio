...
export const CLIENT_EVM_ADDRESS_ECDSA = process.env.CLIENT_EVM_ADDRESS_ECDSA ?? '';
export const CLIENT_ACCOUNT_ID_ECDSA = process.env.CLIENT_ACCOUNT_ID_ECDSA ?? '';
...
export const CLIENT_EVM_ADDRESS_ED25519 = process.env.CLIENT_EVM_ADDRESS_ED25519 ?? '';
export const CLIENT_ACCOUNT_ID_ED25519 = process.env.CLIENT_ACCOUNT_ID_ED25519 ?? '';
