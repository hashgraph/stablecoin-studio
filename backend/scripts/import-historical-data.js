...
const MONTH_MAP = {
        'janv.': 0, 'janv': 0, 'janvier': 0, 'jan': 0,
        'févr.': 1, 'févr': 1, 'février': 1, 'feb': 1,
        'mars': 2, 'mar': 2,
        'avr.': 3, 'avr': 3, 'avril': 3, 'apr': 3,
        'mai': 4, 'may': 4,
        'juin': 5, 'jun': 5,
        'juil.': 6, 'juil': 6, 'juillet': 6, 'jul': 6,
        'août': 7, 'aug': 7,
        'sept.': 8, 'sept': 8, 'septembre': 8, 'sep': 8,
        'oct.': 9, 'oct': 9, 'octobre': 9,
        'nov.': 10, 'nov': 10, 'novembre': 10,
        'déc.': 11, 'déc': 11, 'décembre': 11, 'dec': 11,
};
